...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (form) {
    form.addEventListener("submit", async function (e) {
      ...
      messages.innerHTML = "├ó┬Å┬│ Sending message...";
      ...
      try {
        ...
        if (response.ok) {
          ...
          messages.innerHTML = "├ó┼ôΓÇª " + text;
          form.reset();
        } else {
          messages.className = "alert alert-danger";
          messages.innerHTML = "├ó┬¥┼Æ " + text;
        }
      } catch (error) {
        messages.className = "alert alert-danger";
        messages.innerHTML = "├ó┬¥┼Æ Error sending message. Please try again.";
      }
    });
  }
});
...
(async function loadGitHubProjects() {
  ...
  const PROJECT_META = {
    "amar_recipe": {
      ...
      problem: "Finding authentic Bangladeshi recipes online is scattered and unreliable ΓÇö there's no dedicated, clean platform for Food Lovers.",
    ...
    "uiu-health-care": {
      ...
      impact: "A functional healthcare portal for UIU that simplifies student-doctor interactions and appointment booking -ΓÇ¥ live and accessible.",
    ...
    "uiusupplements": {
      ...
      impact: "Helped a local business launch an online supplement store ΓÇö enabling product listing, cart, and order management for campus customers.",
